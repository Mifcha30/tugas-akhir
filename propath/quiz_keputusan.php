...
if(!isset($_SESSION['user_id'])) {
    header("Location: login_keputusan.php");
    exit();
}

$questions = [
    "Saya ingin bekerja sesuai dengan jurusan.",
    "Saya ingin bekerja sesuai dengan bakat yang saya miliki.",
    "Saya ingin bekerja dengan gaji yang tinggi (diatas UMR).",
    "Saya merasa kesal dengan suatu hal yang tidak sesuai keinginan saya.",
    "Mendaftar pekerjaan yang sesuai dengan kemampuan yang saya miliki.",
    "Saya harus memilih pekerjaan sesuai dengan bakat dan minat saya.",
    "Dalam mendaftar pekerjaan saya memperhatikan persyaratan yang ditentukan.",
    "Saya ingin bekerja diluar kota (merantau).",
    "Saya ingin bekerja yang membuat saya semakin berkembang.",
    "Dalam memilih pekerjaan saya berfikir jangka penjang dari pekerjaan tersebut.",
    "Bekerja sesuai dengan kemampuan yang dimiliki.",
    "Orang tua menyerahkan segala urusan pekerjaan kepada saya.",
    "Saya berusaha memberikan yang terbaik untuk perusahaan.",
    "Memilih kerja serabutan daripada kerja di PT yang penuh dengan tuntutan.",
    "Setiap pekerjaan mempunyai resiko dan saya siap menanggung resiko ditempat kerja saya.",
    "Saya suka bekerja dengan sesuka hati.",
    "Kuliah sangat penting bagi saya karena untuk menentukan masa depan yang lebih baik.",
    "Mengikuti training/pelatihan agar bisa diterima diperusahaan.",
    "Bekerja juga mencari pengalaman bukan sekedar mencari uang."
];
...
if (isset($_POST['submit'])) {
    ...
    if (empty($unansweredQuestions)) {
        ...
        if ($totalScore >= 80 && $totalScore <= 100) {
            $category = "Pengambilan Keputusan sangat tinggi";
        } elseif ($totalScore >= 60 && $totalScore <= 79) {
            $category = "Pengambilan Keputusan tinggi";
        } elseif ($totalScore >= 40 && $totalScore <= 59) {
            $category = "Pengambilan Keputusan sedang";
        } elseif ($totalScore >= 20 && $totalScore <= 39) {
            $category = "Pengambilan Keputusan rendah";
        } else {
            $category = "Pengambilan Keputusan sangat rendah";
        }

        // Koneksi ke database
        $conn = new mysqli("localhost", "root", "", "pengambilan_keputusan");
        if ($conn->connect_error) {
            ...
            if ($stmt->execute()) {
                $resultHTML = "<div class='result-container'>
                    ...
                    <p><a href='logout_keputusan.php' style='color: #fff; text-decoration: none;'>Logout</a></p>
                </div>";
                $showForm = false;
...
<head>
    ...
    <title>Kuis Pengambilan Keputusan</title>
    <style>
        body {
...
<body>
    <div class="quiz-container">
        <h1>Kuis Pengambilan Keputusan</h1>
