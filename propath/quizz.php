...
$questions = [
    ...
    "Saya jarang belajar karena saya menerima hasil apa adanya.",
    "Saya mengerjakan sesuatu mengalir saja, tanpa target.",
    "Saya sangat takut dengan kegagalan.",
    "Saya menerima pendapat orang lain sebagai masukan untuk perbaikan diri.",
    "Saya tidak suka dengan orang yang mengkritik apa yang saya lakukan.",
    "Di lingkungan yang baru, saya tidak akan menyapa orang sebelum disapa.",
    "Saya merasa kelebihan saya dibutuhkan orang lain.",
    "Saya selalu berusaha menjadikan kekurangan sebagai kelebihan saya.",
    "Saya menyukai tantangan.",
    "Saya tidak suka bekerja dengan berkelmpok.",
    "Saya tidak suka berteman dengan orang yang tidak sepaham dengan saya."
];
...
if (isset($_POST['submit'])) {
    ...
    if (empty($unansweredQuestions)) {
        ...
        if ($totalScore >= 80 && $totalScore <= 100) {
            $category = "Kepercayaan Diri sangat tinggi";
        } elseif ($totalScore >= 60 && $totalScore <= 79) {
            $category = "Kepercayaan Diri tinggi";
        } elseif ($totalScore >= 40 && $totalScore <= 59) {
            $category = "Kepercayaan Diri sedang";
        } elseif ($totalScore >= 20 && $totalScore <= 39) {
            $category = "Kepercayaan Diri rendah";
        } else {
            $category = "Kepercayaan Diri sangat rendah";
        }
        ...
        if ($conn->connect_error) {
            ...
            if ($stmt->execute()) {
                $resultHTML = "<div class='result-container'>
                    ...
                    <p><a href='logout.php' style='color: #fff; text-decoration: none;'>Logout</a></p>
                </div>";
                $showForm = false;
...
<head>
    ...
    <title>Kuis Kepercayaan Diri</title>
    <style>
        body {
