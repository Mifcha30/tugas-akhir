...
if(!isset($_SESSION['user_id'])) {
    header("Location: login_mandiri.php");
    exit();
}

$questions = [
    "Saya tidak pernah berkunjung ke perpustakaan untuk mengerjakan tugas/belajar.",
    "Keinginan belajar saya masih rendah.",
    "Saya mencari referensi buku di perpustakaan .",
    "Saat berdiskusi saya aktif bertanya.",
    "Saat berdiskusi saya tidak pernah memperhatikan materi.",
    "Apa yang saya peroleh dalam diskusi saya terapkan dalam kelas.",
    "Saya selalu membuat jadwal belajar.",
    "Saya membuat deadline penyelesaian tugas.",
    "Saya membuat jadwal belajar tetapi tidak melaksanakannya.",
    "Saya selalu memantau perkembangan hasil belajar saya.",
    "Ketika hasilnya bagus, saya mempertahankan belajar .",
    "Ketika prestasi menurun/jelek saya tidak lagi belajar.",
    "Saya merasa nyaman belajar di lingkungan saya saat ini .",
    "Saat belajar saya merasa terganggu dengan lingkungan tinggal saya saat ini.",
    "Ketika di perantauan saya tidak bisa membagi waktu antara bermain dan belajar.",
    "Saya bergaul dengan yang rajin belajar.",
    "Saya belajar tergantung dengan teman saya.",
    "Saya tidak suka berteman dengan teman yang banyak main, karena mengurangi jam belajar saya.",
    "Banyak teman yang mengajak saya bermain, tetapi saya lebih memilih belajar."
];
...
if (isset($_POST['submit'])) {
    ...
    if (empty($unansweredQuestions)) {
        ...
        if ($totalScore >= 80 && $totalScore <= 100) {
            $category = "Kemandirian Belajar sangat tinggi";
        } elseif ($totalScore >= 60 && $totalScore <= 79) {
            $category = "Kemandirian Belajar tinggi";
        } elseif ($totalScore >= 40 && $totalScore <= 59) {
            $category = "Kemandirian Belajar sedang";
        } elseif ($totalScore >= 20 && $totalScore <= 39) {
            $category = "Kemandirian Belajar rendah";
        } else {
            $category = "Kemandirian Belajar sangat rendah";
        }


        // Koneksi ke database
        $conn = new mysqli("localhost", "root", "", "kemandirian_belajar");
        if ($conn->connect_error) {
            ...
            if ($stmt->execute()) {
                $resultHTML = "<div class='result-container'>
                    ...
                    <p><a href='logout_mandiri.php' style='color: #fff; text-decoration: none;'>Logout</a></p>
                </div>";
                $showForm = false;
...
<head>
    ...
    <title>Kuis Kemandirian Belajar</title>
    <style>
        body {
...
<body>
    <div class="quiz-container">
        <h1>Kuis Kemandirian Belajar</h1>
